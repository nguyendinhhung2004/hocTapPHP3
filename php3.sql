...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 10, 2024 lúc 02:06 PM
...
INSERT INTO `category` (`id`, `name_dm`, `ccreated_at`, `update_at`) VALUES
(1, 'Nước ngọt', NULL, NULL),
(2, 'Nước ngọt', NULL, NULL);
...
INSERT INTO `product` (`id`, `name`, `category_id`, `price`, `view`, `created_at`, `updated_at`) VALUES
(1, 'Coca-cola 2', 1, 20000, 500, '2024-07-10 08:05:27', '2024-07-10 08:31:25'),
(3, 'Pessi', 1, 10000, 345, '2024-07-10 08:31:42', '2024-07-10 08:31:42'),
(4, 'Fanta', 1, 5000, 7000, '2024-07-10 08:34:12', '2024-07-10 08:34:12');
...
(35, 'Trần Thị Kim Hiếu 2', 'tranthikimhieu@haui.edu.vn2', 3, 2, 35, '2024-05-21 08:08:09', '2024-07-10 06:35:20'),
(2484, 'da', 'daw', 3, 0, 43, '2024-07-10 06:37:25', '2024-07-10 06:37:25');
...
--
ALTER TABLE `users`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2485;
COMMIT;
